...
```bash
python run.py --config-path=weights/OFA  ++pretrained_weight=weights/OFA/OFA_MBV3_k357_d234_e46_w1.pth
```

# Result

```bash
(nas) [hyperbox@server hyperbox]$ python run.py --config-path=weights/OFA ++pretrained_weight=weights/OFA/OFA_MBV3_k357_d234_e46_w1.pth
